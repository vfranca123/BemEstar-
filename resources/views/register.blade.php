    ...
    <div id="bigBox">
        <form enctype="multipart/form-data" id="littleBox" action="{{ route('register.store') }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="inputPassword3" name="date" placeholder="22/04/2022">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="email" class="form-control" id="inputEmail3" name="email" placeholder="XXXXXXX@yyyyyyy">
                </div>
              </div>
